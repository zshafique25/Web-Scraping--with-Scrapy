...
df = pd.read_json('C:\\Users\\Zain\\Documents\\Bytewise fellowship\\scrapy\\scrapy-project\\collect\\.data\\data.jsonl', lines=True)
...
conn = sqlite3.connect('C:\\Users\\Zain\\Documents\\Bytewise fellowship\\scrapy\\scrapy-project\\collect\\.data\\quotes.db')
